...
__attribute__((section("__versions"))) = {
	...
	{ 0x986ddabc, __VMLINUX_SYMBOL_STR(security_bprm_check_set_dew_filter) },
	...
	{ 0xb3617caf, __VMLINUX_SYMBOL_STR(security_bprm_check_unset_dew_filter) },
...
MODULE_INFO(srcversion, "609103C25B9C162A5F5FBBE");
